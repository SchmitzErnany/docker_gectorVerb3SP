...
from deep.gectorPredict.utils.helpers import START_TOKEN
...
class PretrainedBertIndexer(WordpieceIndexer):
    ...
    def __init__(self,
        ...
        bert_tokenizer = AutoTokenizer.from_pretrained(
            pretrained_model, do_lower_case=bool(do_lowercase), do_basic_tokenize=False)
        ...
        if "roberta" in pretrained_model and "xlm" not in pretrained_model:
